...
public class OrderedObjectManager<T extends OrderedObject> extends BaseObject implements ObjectManager<T>
{
    ...
    public static <K, T extends OrderedObject> OrderedObjectManager<T> newManager( int size )
    {
        ...
        return new OrderedObjectManager<T>( objects, pendingAdditions, pendingRemovals );
    }
    
    private OrderedObjectManager( FixedSizeArray<T> objects,
